...
@section('navbar')
    ...
    <!-- Body -->
        <div class="container">
            <div class="jumbotron">
                <div class="row">
                        <div class="w3-animate-top w3-black" id="txt" style="height: 160px; width: 160px; font-size: 27px; padding: 55px 0px 0 8px; border-radius: 50%; margin: 0 auto; border:8px solid #5a738e"></div>
