...
@section('navbar')
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="btn btn-lg btn-success" style="margin:auto 15px"><a href="{{ route('admin-login') }}"
                                                                                   class="w3-text-black">Admin Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <!-- Body -->
        <div class="container">
            <div class="jumbotron">
                <div class="row">
                        <div class="w3-animate-top w3-black" id="txt" style="height: 160px; width: 160px; font-size: 27px; padding: 55px 0px 0 0px; border-radius: 50%; margin: 0 auto; border:8px solid #5a738e"></div>
